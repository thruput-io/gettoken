...
export UNPRIVILEGED_USER="nobody"

export ARCHIVE_SIGNING_KEY=""
export PUBLISH_DEB_COMMAND="scripts/publish-to-pages.sh gh-pages deb"
export PUBLISH_BREW_COMMAND="scripts/publish-to-pages.sh gh-pages brew"
