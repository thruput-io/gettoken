...
required ROOT_DIR BRANCH SITE_URL PACKAGE_FORMATS INSTALL_COMMAND BUILD_DEPS SEMGREP_INSTALL_COMMAND BATS_LIB_PATH PATH_PREFIX ARCHIVE_SIGNING_KEY
export ROOT_DIR BRANCH SITE_URL PACKAGE_FORMATS INSTALL_COMMAND BUILD_DEPS SEMGREP_INSTALL_COMMAND BATS_LIB_PATH PATH_PREFIX ARCHIVE_SIGNING_KEY
expose ROOT_DIR BRANCH SITE_URL PACKAGE_FORMATS INSTALL_COMMAND BUILD_DEPS SEMGREP_INSTALL_COMMAND BATS_LIB_PATH PATH_PREFIX ARCHIVE_SIGNING_KEY
