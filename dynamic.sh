...
export BRANCH SITE_URL PACKAGE_FORMATS INSTALL_COMMAND BUILD_DEPS ARCHIVE_SIGNING_KEY
expose BRANCH SITE_URL PACKAGE_FORMATS INSTALL_COMMAND BUILD_DEPS ARCHIVE_SIGNING_KEY